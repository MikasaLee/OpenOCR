...
DEFAULT_MODEL_NAME = 'doubao-seed-2-0-mini'
...
DEFAULT_PROMPT = (
    ...
    'First, we define the faked characters: a non-existent character in the dictionary resulting from the incorrect combination of radicals or components. '
    'Now please recognize the provided handwritten image, and mark any faked character with an X.'
